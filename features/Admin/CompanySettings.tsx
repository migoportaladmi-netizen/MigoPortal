...
export default function CompanySettings(props: any) {
    const {
        ...
        handleOpenAssignManager, isInviteUserModalOpen, inviteForm, setInviteForm, handleSendInvite, seatCount, setSeatCount
    } = props;
